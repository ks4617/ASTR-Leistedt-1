...
# %% Correct fluxes
bands = np.array(['G','R','Z','W1','W2', 'W3', 'W4'])
...
photo_sub.write('photo_w1234.fits', format = 'fits')
photo_sub_ebv.write('photo_ebv_w1234.fits', format = 'fits')
spectro_sub.write('spectro_w1234.fits', format = 'fits')
...
# %%
full.write('full_w1234.fits', format = 'fits')
full_ebv.write('full_ebv_w1234.fits', format = 'fits')